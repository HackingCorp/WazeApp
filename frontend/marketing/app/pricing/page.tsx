  ...
  const plans = [
    {
      ...
      features: [
        ...
        { name: t("featureProductCatalog"), included: true },
        { name: t("feature500BroadcastContacts"), included: true },
    ...
    },
    {
      ...
      features: [
        ...
        { name: t("featureProductCatalog"), included: true },
        { name: t("feature2000BroadcastContacts"), included: true },
        { name: t("featureAdvancedAnalytics"), included: true },
    ...
    },
    {
      ...
      features: [
        ...
        { name: t("featureProductCatalog"), included: true },
        { name: t("featureUnlimitedBroadcastContacts"), included: true },
