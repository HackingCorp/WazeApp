...
export class AddPerformanceIndexes1784000000002 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`
      CREATE INDEX CONCURRENTLY IF NOT EXISTS "IDX_MSG_EXTERNAL_ID"
    ...
    await queryRunner.query(`
      CREATE INDEX CONCURRENTLY IF NOT EXISTS "IDX_MSG_CONV_SEQ"
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`
      DROP INDEX CONCURRENTLY IF EXISTS "IDX_CONV_AGENT_UPDATED"
    `);
    await queryRunner.query(`
      DROP INDEX CONCURRENTLY IF EXISTS "IDX_CONV_UPDATED_AT"
    `);
    await queryRunner.query(`
      DROP INDEX CONCURRENTLY IF EXISTS "IDX_MSG_CONV_ROLE_DATE"
    `);
    await queryRunner.query(`
      DROP INDEX CONCURRENTLY IF EXISTS "IDX_MSG_CONV_SEQ"
    `);
    await queryRunner.query(`
      DROP INDEX CONCURRENTLY IF EXISTS "IDX_MSG_EXTERNAL_ID"
    `);
  }
}
