...
async function getAIResponse(message: string, userLanguage: string = 'en'): Promise<string> {
  try {
    ...
    const fallbackResponses: Record<string, string> = {
      ...
      pricing: "Excellente question ! WazeApp propose le plan STANDARD à $29/mois, PRO à $49/mois (le plus populaire), et ENTERPRISE à $199/mois avec messages illimités. La facturation annuelle permet d'économiser 20%. Voulez-vous essayer gratuitement ?",
