            ...
            <div className="grid grid-cols-3 gap-6">
              <div className="flex items-center space-x-2">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">{t("heroResponseTime")}</p>
                </div>
              </div>
              <div className="flex items-center space-x-2">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">{t("heroLanguages")}</p>
                </div>
              </div>
              <div className="flex items-center space-x-2">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">{t("heroAvailable")}</p>
                </div>
              </div>
            </div>
          </div>
