...
export default function LoginPage() {
  ...
  const handleSocialLogin = (provider: string) => {
    ...
    // Redirect to real OAuth endpoints
    switch (provider) {
      case 'google':
      ...
      case 'facebook':
        ...
        break
      default:
        setError(`${provider} login not supported`)
        setIsLoading(false)
    }
  }
      ...
      >
        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-muted-foreground mt-2">Sign in to your WizeApp account</p>
          </div>
          ...
          <div className="mt-6">
            ...
            <div className="mt-4 text-center">
              <button
                onClick={() => console.log("Magic link")}
