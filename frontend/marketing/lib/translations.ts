...
export const translations = {
  en: {
    ...
    feature2GBStorage: "2GB storage",
    feature5GBStorage: "5GB storage",
    feature10GBStorage: "10GB storage",
    feature20GBStorage: "20GB storage",
    featureUnlimitedMessages: "Unlimited messages/month",
    ...
    featureScheduling: "Scheduled messages",
    featureWebhooks: "Webhooks integration",
...
Ready to future-proof your business? Try WazeApp free and experience the future today.`,
    ...
    loginSubtitle: "Sign in to your WazeApp account",
    ...
    loginNetworkError: "Unable to connect to authentication server. Please try again.",

    // Verify Email Page
    verifyEmailBackToLogin: "Back to login",
    verifyEmailTitle: "Verify your email",
    verifyEmailVerified: "Email Verified!",
    verifyEmailDescription: "We sent you a verification email. Please check your inbox and click the verification link.",
    verifyEmailVerifying: "Verifying your email...",
    verifyEmailSuccess: "Your email has been successfully verified!",
    verifyEmailFailed: "Email verification failed. The token may be invalid or expired.",
    verifyEmailNetworkError: "Network error. Please try again.",
    verifyEmailRedirecting: "Redirecting to dashboard in 3 seconds...",
    verifyEmailContinueLogin: "Go to Dashboard",
    verifyEmailDidntReceive: "Didn't receive the email? Check your spam folder or resend it.",
    verifyEmailAddressLabel: "Email address",
    verifyEmailResendSending: "Sending...",
    verifyEmailResendButton: "Resend verification email",
    verifyEmailResendSuccess: "Verification email sent! Please check your inbox.",
    verifyEmailResendFailed: "Failed to send verification email. Please try again.",
    verifyEmailAlreadyVerified: "Already verified?",
    verifyEmailSignIn: "Sign in",
    verifyEmailEnterEmail: "Please enter your email address",
    verifyEmailGoToDashboard: "Go to Dashboard",
    verifyEmailSkipNote: "You can also access your dashboard directly — email verification is optional.",
  },
  fr: {
    // Navigation
    ...
    feature2GBStorage: "2GB de stockage",
    feature5GBStorage: "5GB de stockage",
    feature10GBStorage: "10GB de stockage",
    featureUnlimitedMessages: "Messages illimités/mois",
    ...
    featureScheduling: "Messages programmés",
    featureWebhooks: "Intégration Webhooks",
...
Prêt à pérenniser votre entreprise ? Essayez WazeApp gratuitement et expérimentez l'avenir dès aujourd'hui.`,
    ...
    loginSubtitle: "Connectez-vous a votre compte WazeApp",
    ...
    loginSignUpFree: "Inscrivez-vous gratuitement",
    loginInvalidCredentials: "Email ou mot de passe incorrect",
    loginNetworkError: "Impossible de se connecter au serveur. Veuillez reessayer.",

    // Verify Email Page
    verifyEmailBackToLogin: "Retour a la connexion",
    verifyEmailTitle: "Verifiez votre email",
    verifyEmailVerified: "Email verifie !",
    verifyEmailDescription: "Nous vous avons envoye un email de verification. Verifiez votre boite de reception et cliquez sur le lien.",
    verifyEmailVerifying: "Verification de votre email...",
    verifyEmailSuccess: "Votre email a ete verifie avec succes !",
    verifyEmailFailed: "La verification a echoue. Le lien est peut-etre invalide ou expire.",
    verifyEmailNetworkError: "Erreur reseau. Veuillez reessayer.",
    verifyEmailRedirecting: "Redirection vers le tableau de bord dans 3 secondes...",
    verifyEmailContinueLogin: "Acceder au tableau de bord",
    verifyEmailDidntReceive: "Vous n'avez pas recu l'email ? Verifiez vos spams ou renvoyez-le.",
    verifyEmailAddressLabel: "Adresse email",
    verifyEmailResendSending: "Envoi en cours...",
    verifyEmailResendButton: "Renvoyer l'email de verification",
    verifyEmailResendSuccess: "Email de verification envoye ! Verifiez votre boite de reception.",
    verifyEmailResendFailed: "Echec de l'envoi. Veuillez reessayer.",
    verifyEmailAlreadyVerified: "Deja verifie ?",
    verifyEmailSignIn: "Se connecter",
    verifyEmailEnterEmail: "Veuillez entrer votre adresse email",
    verifyEmailGoToDashboard: "Acceder au tableau de bord",
    verifyEmailSkipNote: "Vous pouvez aussi acceder directement a votre tableau de bord — la verification email est optionnelle.",
  },
  es: {
    // Navigation
    ...
    feature2GBStorage: "2GB de almacenamiento",
    feature5GBStorage: "5GB de almacenamiento",
    feature10GBStorage: "10GB de almacenamiento",
    featureUnlimitedMessages: "Mensajes ilimitados/mes",
    ...
    featureScheduling: "Mensajes programados",
    featureWebhooks: "Integración Webhooks",
...
¿Listo para preparar tu negocio para el futuro? Prueba WazeApp gratis y experimenta el futuro hoy.`
  ...
  de: {
    ...
    feature2GBStorage: "2GB Speicher",
    feature5GBStorage: "5GB Speicher",
    feature10GBStorage: "10GB Speicher",
    featureUnlimitedMessages: "Unbegrenzte Nachrichten/Monat",
    ...
    featureScheduling: "Geplante Nachrichten",
    featureWebhooks: "Webhooks-Integration",
  ...
  it: {
    ...
    feature2GBStorage: "2GB di storage",
    feature5GBStorage: "5GB di storage",
    feature10GBStorage: "10GB di storage",
    featureUnlimitedMessages: "Messaggi illimitati/mese",
    ...
    featureScheduling: "Messaggi programmati",
    featureWebhooks: "Integrazione Webhooks",
  ...
  pt: {
    ...
    feature2GBStorage: "2GB de armazenamento",
    feature5GBStorage: "5GB de armazenamento",
    feature10GBStorage: "10GB de armazenamento",
    featureUnlimitedMessages: "Mensagens ilimitadas/mês",
    ...
    featureScheduling: "Mensagens agendadas",
    featureWebhooks: "Integração Webhooks",
  ...
  zh: {
    ...
    feature2GBStorage: "2GB存储",
    feature5GBStorage: "5GB存储",
    feature10GBStorage: "10GB存储",
    featureUnlimitedMessages: "无限消息/月",
  ...
  ja: {
    ...
    feature2GBStorage: "ストレージ2GB",
    feature5GBStorage: "ストレージ5GB",
    feature10GBStorage: "ストレージ10GB",
    featureUnlimitedMessages: "無制限メッセージ/月",
  ...
  ar: {
    ...
    feature2GBStorage: "2 جيجابايت تخزين",
    feature5GBStorage: "5 جيجابايت تخزين",
    feature10GBStorage: "10 جيجابايت تخزين",
    featureUnlimitedMessages: "رسائل غير محدودة/شهر",
